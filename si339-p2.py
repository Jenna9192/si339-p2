...
# Debugging: Print found CSV files
print("CSV files found:", csv_files)

# Check if we have at least one file
if not csv_files:
    print("No CSV files found in the 'athletes' folder or its subdirectories.")
    exit()

# Process the first CSV file (change index if needed)
csv_file_path = csv_files[0]
print(f"Processing file: {csv_file_path}")  # Debugging
data = process_csv(csv_file_path)

# Debugging: Print extracted data
print("Data extracted from CSV:", data)
...
# Generate HTML sections for athletes
athlete_sections = ""
for athlete in data:
    #print (athlete)
    athlete_sections += f'''
...
# Debugging: Print generated HTML sections
#print("Generated HTML sections:", athlete_sections)

# Fill the HTML template with generated athlete sections
html_content = html_template.format(athlete_sections=athlete_sections)
...
#             <tbody>
#                 <tr>
#                     <td>{athlete['grade'] if athlete['grade'] else ''}</td>
#                     <td>{athlete['overall_place'] if athlete['overall_place'] else ''}</td>
#                     <td>{athlete['time'] if athlete['time'] else ''}</td>
#                     <td>{athlete['meet'] if athlete['meet'] else ''}</td>
#                     <td>{athlete['date'] if athlete['date'] else ''}</td>
#                 </tr>
#             </tbody>
#         </table>
#     </section>
